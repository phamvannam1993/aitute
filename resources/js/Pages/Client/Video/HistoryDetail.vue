    ...
    <section class="flex flex-col gap-4">
            <div class="flex flex-row gap-4 justify-between text-black">
                ...
                <div class="flex justify-between items-center my-5 ">
                    <a href="javascript:void(0)" class="bt-yellow px-4 md:px-11 py-2 bg-orion-primary text-white font-semibold rounded-[5px] flex justify-center items-center gap-1 mx-5"  @click="videoHistory()">Lịch sử</a>
                </div>            
                </div>
            <div class="flex w-full flex-col lg:flex-row justify-around gap-10 lg:gap-0">
                ...
                <div class="relative w-full lg:w-[60%] overflow-hidden">
                    <div class="aspect-video w-full">
                        <div class="w-full flex flex-row md:flex-col mt-2 md:w-full xl:w-full lg:pb-[4px] items-center">
                            ...
                            class="w-full h-full rounded-[20px] bg-black max-h-[600px] " :class="recordData.ratio == '1080:1920' ? 'video-ratio' : ''"></video>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-center" v-for="(item, index) in histories"
                        :key="index">
                        <Link
                            :href="route('video.historyDetail', {
                                id: item.id,
                            })"
