<template>
    ...
    <div
        class="flex overflow-y-auto bg-[url('../../public/assets/img/aiwow/layout_background.png')] bg-cover bg-center"
    >
        <div class="w-full p-5 lg:p-10 pt-[50px] lg:pt-[25px]">
            <div
            ...
            >
                ...
                <div class="w-full">
                    ...
                    >
                        <h2 class="text-[#092A99] font-bold text-2xl mb-4">
                            Lịch sử tạo hình ảnh
                        </h2>
                        <a
                            :href="route('ai-image-advertisement.index')"
    ...
    <ShowDetailImage :selectedImage="selectedImage" :closeDetail="closeDetail" :hiddenFeature="['face-swap']" :routerDelete="'ai-image-advertisement.delete'" :shareLinkableType="'AiGeneratedBannerPoster'" />
...
const confirmDelete = async () => {
    ...
    try {
        const response = await axios.post(
            route("ai-image-advertisement.delete", { id: imageDeleteId.value })
        );
