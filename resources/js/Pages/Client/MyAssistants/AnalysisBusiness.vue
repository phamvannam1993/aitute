            ...
            <div class="flex flex-col flex-1"  v-if="props.formData?.length > 0">
                ...
                <div class="flex items-center justify-center gap-5 mt-7">
                    <button
                        ...
                        type="button" @click="props.handleButtonClick" class="relative gap-1 flex items-center justify-center h-[40px] md:h-[50px] place-items-center w-full max-w-[180px] px-4 bg-ai3goc-sec text-white rounded-2xl font-bold">
