        ...
        <div class="flex flex-col">
            <div class="flex justify-center gap-2 md:gap-4 mb-4 h-[40px]">
                <button @click="autoCreateVideo"
                    ...
                    class="w-[35%] sm:w-1/3 bg-ai3goc-sec text-white py-2.5 font-bold text-xs lg:text-sm rounded-2xl lg:rounded-2xl text-center hover:bg-cyan-600 flex items-center gap-2 justify-center">
                        Tự động tạo video
                </button>
                <label :id="`video_${index}`" class="w-[30%] sm:w-1/3 cursor-pointer bg-ai3goc-sec hover:bg-cyan-600 font-bold text-white text-center py-2 text-xs lg:text-sm rounded-2xl lg:rounded-2xl flex items-center gap-2 justify-center">
                ...
                <button @click="scrollToCreateFormRef()" class="w-[30%] sm:w-1/3 bg-ai3goc-sec hover:bg-cyan-600 font-bold text-white text-center py-2 text-xs lg:text-sm rounded-2xl flex items-center gap-2 justify-center">
                    ...
                    <div class="relative w-full">
                        <div v-if="videoRef || previewVideoUpload" class="flex relative items-center justify-center bg-gray-200 rounded-lg lg:rounded-2xl aspect-[4/3] w-full h-full overflow-hidden">
                            <label class="ml-0 w-16 h-16 cursor-pointer top-0 right-0 p-2 z-10 text-right absolute">
                                <input type="checkbox" :checked="checkedVideo" @change="selectVideo()" class="rounded-full" />
                            </label>
