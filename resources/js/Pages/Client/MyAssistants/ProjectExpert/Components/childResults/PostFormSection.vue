        ...
        <div>
            ...
            <div  class="my-8 flex justify-center items-center gap-6">
                ...
                <button type="button" @click="handlePostFacebook(3)"
                    class="min-w-[100px] flex items-center justify-center gap-2 md:min-w-[150px] px-2 md:px-4 py-2 lg:py-3 bg-orion-sec text-white rounded-lg lg:rounded-2xl font-bold text-sm">
                    Duyệt bài
                </button>
            </div>
        </div>
