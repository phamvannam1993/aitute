    ...
    <div class="mt-4">
        ...
        <div class="flex flex-col">
            <div class="flex justify-center gap-2 md:gap-4 mb-4 h-[40px]">
                ...
                <button @click="scrollToCreateFormRef()" class="w-[30%] sm:w-1/3 bg-orion-sec hover:bg-cyan-600 font-bold text-white text-center py-2 text-xs lg:text-sm rounded-2xl flex items-center gap-2 justify-center">
...
<script setup>
    ...
    const selectVideo = () => {
        ...
        formData.append("res_video_url", results.value.video_url)
        emit('updateProject', formData);
    }
