    ...
    <Head title="Lịch sử tạo ảnh tự sướng - AI 3 GỐC - Cộng đồng AI tử tế" />
        <Layout :breadcrumbs="breadcrumbsData">
            <div
                            ...
                            <a :href="route('ai-image.my-ai-image')"
                                class="px-4 md:px-11 py-2 bg-orion-sec text-white font-semibold rounded-[15px] flex justify-center items-center gap-1"><svg
...
const fetchData = (page) => {
  const url = `/ai-image/my-ai-image-history?page=${page}`;
