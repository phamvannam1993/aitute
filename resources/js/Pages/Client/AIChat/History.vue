<template>
    ...
    <Head title="Lịch sử Chatbot - AI 3 GỐC - Cộng đồng AI tử tế" />
  
    <Layout :breadcrumbs="breadcrumbData" :isChatbotHistory="true">
      <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex justify-end">
          <button @click="checkAllMessagesStatus" :disabled="isChecking"
            class="px-3 lg:px-4 py-3 bg-ai3goc-sec hover:bg-ai3goc-sec/60 text-white rounded-[16px] transition-all duration-200 flex items-center gap-2"
      ...
      <div style="overflow-x:auto;" class="mb-4">
        <div class="w-full font-bold text-black flex items-center mb-4 ">
          ...
          <div class="w-[60px] lg:w-[200px] flex justify-center items-center">
          ...
          <div class="hidden lg:flex lg:w-[120px] justify-center items-center">
        ...
        :class="openChats[user_page_id] 
          ...
          <div :class="openChats[user_page_id] 
            ...
            <div class="w-[60px] lg:w-[200px] flex justify-center items-center border-r-[2px] lg:border-l-[2px] border-[#D4D4D4] p-1 lg:p-4 h-full">
            ...
            <div class="flex-1 flex items-center border-l-[2px] lg:border-r-[2px] border-[#D4D4D4] p-1 lg:p-4 h-full gap-2">
              ...
              <button @click.stop="openPromotionDialog(user_page_id)"
                ...
                <span class="hidden lg:block">Gửi tin nhắn tự động</span>
              ...
              <span class="block lg:hidden transition-transform duration-300 ease-in-out"
                    :class="openChats[user_page_id] ? 'rotate-180 text-blue-500' : 'text-gray-500'">
                ▼
              </span>
            </div>
  
            <div class="hidden lg:w-[120px] lg:flex justify-center items-center h-full">
        ...
        <div class="p-4">
          <div class="relative">
            <textarea 
              ...
              class="w-full h-32 p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div class="flex justify-end mt-4 space-x-2">
            ...
            <button 
              ...
              :disabled="sendingPromotion[selectedUserPageId] || isLoadingMessage"
  ...
  const confirmSendPromotion = async () => {
    ...
    try {
      const response = await axios.post(route('api.send-promotion-message', selectedUserPageId.value), {
        user_page_id: selectedUserPageId.value,
        message: promotionMessage.value
      });
      if (response.data.success) {
        toast.success('Đã gửi tin nhắnthành công', {
          autoClose: 2000
        });
