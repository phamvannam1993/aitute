<template>
    ...
    <div
        ...
        <div class="flex lg:flex-row flex-col w-[100%] lg:w-[100%] px-5 justify-between py-[32px]">
            <div class="w-full lg:items-end mb-5 space-y-4 lg:space-y-0 lg:space-x-4 lg:py-5 gap-8">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <a :href="route('home.index')">
                                <img src="/assets/img/admin/icon_left_home.png" alt="Trang chủ"
                                    class="w-auto h-[19px]" />
                            </a>
                            <span class="font-medium text-[#2C75E3]">/ Phim / Lịch sử
                            </span>
                        </div>
                        <Credit />
                    </div>
                    ...
                    <div class="flex w-full flex-col lg:flex-row justify-around gap-10 lg:gap-0">
                        ...
                        <div class="relative w-full lg:w-[60%] overflow-hidden">
                            <div class="aspect-video w-full">
                                <video :src="recordData.transcription_url && showTranscription ? recordData.transcription_url : recordData.result_url" controls preload="auto"
                                    class="w-full h-full rounded-[20px] bg-black"></video>
                                <div
                                    class="absolute top-4 right-4 cursor-pointer bg-black/50 p-2 rounded-full hover:bg-black/70 transition-all"
                                    :class="{ 'opacity-50 cursor-not-allowed': isTranscribing }">
                                    <img src="/assets/svgs/live-transcribe-svgrepo-com.svg" alt="Transcription"
                                        class="w-6 h-6" :class="{ 'animate-spin': isTranscribing }" @click="toggleTranscription" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-center" v-for="(item, index) in histories"
                                :key="index">
                                    ...
                                    <div
                                        ...
                                        ">
                                            <div
                                                ...
                                                <!-- Giảm chiều cao cho box avatar_url -->
...
const toggleTranscription = async () => {
    ...
    try {
        ...
        const response = await axios.post(route('mc-virtual.create-video-with-transcription'), {
