<template>
    ...
    <div class="relative w-full mx-auto bg-[url('../../public/assets/img/aiwow/layout_background.png')] bg-cover bg-center min-h-screen p-5 lg:p-10 text-xs lg:text-sm lg:px-[15%] mb-20">
        ...
        <div class="w-full overflow-y-auto text-center bg-white text-black rounded-[25px] min-w-2/3 py-2 px-3">
            <div data-v-064b5a97="" class="aspect-video w-full">
                <video v-if="props.url" :src="props.url" controls class="w-full rounded-[20px] bg-black"></video>
            </div>
        </div>
    </div>
</template>
