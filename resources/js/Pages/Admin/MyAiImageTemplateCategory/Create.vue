    ...
    <Master>
        <div
            ...
            <div
                ...
                <div class="w-full lg:w-3/4 flex flex-col space-y-2">
                    <div class="flex items-center space-x-2 text-white">
                        ...
                        <span class="font-medium text-white">/ Danh mục</span>
                        <span class="font-medium text-white">/ Tạo danh mục</span>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-[30px] md:w-2/3 md:min-h-4/5 mx-auto p-4 md:px-12 md:pt-10 md:pb-8">
                ...
                <div class="">
                    <Form :submit="submit" :imageCollections="imageCollections"
...
defineProps({ imageTemplateCategory: Object, imageCollections: Object });

let submit = (form) => {
    router.post(route("admin.my-ai-image-template-categories.store"), form);
};
</script>
