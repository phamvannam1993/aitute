                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="flex flex-col md:flex-row mb-4">
                        <div class="w-full md:w-3/4 pr-0 md:pr-2 mb-4 md:mb-0">
                            ...
                            <input  v-model="operation.name"  type="text" placeholder="Nhập Tên ngành nghề..." class="w-full p-2 border rounded-lg text-gray-700">
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <SelectBoxSearch v-model="operation.occupation_id" :name="operation.occupation.name || '' "></SelectBoxSearch>
                    </div>
                    <!-- Description Field -->
                    <div class="mb-4">
                        <label class="block text-gray-700">Mô tả</label>
                        <textarea rows="8" cols="50" v-model="operation.description" placeholder="Nhập mô tả ngành nghề..." class="w-full p-2 border rounded-lg text-gray-700"></textarea>
                    </div>
...
<script setup>
    ...
    const imageUrl = ref(props.operation.image_url || null);
    let imageFile = null;
    ...
    const submitForm = async () => {
        ...
        try {
            ...
            formData.append('occupation_id', props.operation.occupation_id);
            formData.append('name', props.operation.name);
            formData.append('description', props.operation.description);
            ...
            await axios.post(`/admin/operation/${props.operation.id}/update`, formData).then(response => {
                setTimeout(() => {
