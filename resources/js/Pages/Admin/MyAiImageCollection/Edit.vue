            ...
            <div
                ...
                <div class="w-full lg:w-3/4 flex flex-col space-y-2">
                    <div class="flex items-center space-x-2 text-white">
                        ...
                        <span class="font-medium text-white">/ Chỉnh sửa bộ sưu tập</span>
                    </div>
                </div>
            </div>

            <div class="bg-white mb-10 rounded-[30px] md:w-2/3 md:min-h-4/5 mx-auto p-4 md:px-12 md:pt-10 md:pb-8">
...
const { imageCollection } = defineProps({ imageCollection: Object, configAffs: Array });

let submit = (form) => {
    router.post(route("admin.my-ai-image-collections.update", { id: imageCollection.id }), form, {
        preserveScroll: true,
        onSuccess: () => {
