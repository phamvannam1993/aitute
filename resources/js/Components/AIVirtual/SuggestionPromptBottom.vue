    ...
    <div class="w-full flex items-center justify-end mt-1">
        <div class="flex gap-1">
            <div class="flex items-center gap-2">
                <div class="w-[36px] lg:w-[52px] h-[75%] overflow-hidden rounded-full border-[1px] border-[#d4d4d4]">
                    <img class="w-full h-auto object-top" src="/assets/img/orion/big-robot.png" alt="Robot" />
                </div>

                <button type="button" class="rounded-[10px] bg-orion-sec flex-1 py-1.5 lg:py-3 px-2 lg:px-3 flex items-center justify-center gap-1 lg:gap-2 text-white font-bold" @click.stop="handleOpenContentAI">
                    <span class="text-[12px] lg:text-[16px]">Nhờ AI tạo Prompt chi tiết hơn</span>
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="w-full flex flex-col gap-1 items-center">
                <div class="w-full">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <h2 class="text-orion-primary text-base md:text-[24px] font-bold">Gợi ý nội dung</h2>
                    </div>
                    <label class="text-black font-semibold text-[14px] cursor-pointer">
                        <div class="flex items-center gap-1">
                            ...
                            <span class="text-[11px] md:text-sm">Nhập nội dung mô tả cho {{ typeLabel }} bạn muốn tạo</span>
                        </div>
                    </label>
                    <textarea class="w-full h-[100px] text-black mt-2 rounded-[10px] border-[1px] border-orion-sec text-[11px] md:text-sm"
                              rows="30"
                ...
                <button
                    ...
                    :class="{
                        'bg-orion-sec text-white': !isLoading,
                ...
                >
                    ...
                    <span class="text-sm md:text-base">{{ isLoading ? 'Đang tạo...' : 'Tạo' }}</span>
                </button>
            </div>
            ...
            <div class="w-full flex flex-col gap-1 items-center">
                <div class="w-full">
                    <label class="text-black font-semibold text-[14px] cursor-pointer">
                        <div class="flex items-center gap-1">
                            <img src="/assets/img/orion/icon/label-arrow.svg" alt="step" class="w-5 h-auto" />
                            <span class="text-[11px] md:text-sm">Nội dung gợi ý viết bới AIWOW</span>
                        </div>
                    </label>

                    <textarea class="w-full h-[188px] text-black mt-2 rounded-[10px] border-[1px] border-orion-sec text-[11px] md:text-sm"
                              rows="30"
                ...
                <button
                    ...
                    class="text-center right-0 -top-4 py-2 text-white font-semibold rounded-[10px] w-[180px] text-sm md:text-base"
                    :class="{
                        'bg-orion-sec': suggestContent && (maxLength === false || suggestContent.length <= maxLength),
